...
| `ST2-EXP-003` | R-DP-001 | accepted Dedekind real producer | independently complete retained Cauchy route | preserve declared accepted-real interface or explicitly revise contract | R and C; completeness/identity/order | independent R assembly; comparison gate; downstream C rebuild | ACTIVE / TOTAL-ORDER V5 32634079706 PASS / ORDER-COMPATIBILITY+INVERSE+COMPLETION OPEN |
...
actual closure. `ST2-EXP-002` is also CLOSED / PASS: its independent Q closure contains zero P
declarations, its post-completion Junction gives an explicit P/Q field
