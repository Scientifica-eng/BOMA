/- Nonzero multiplicative inverse existence for selected Dedekind reals.
This layer is assembled only from the positive inverse relation, localized total
order for the sign split, and the accepted ordered-commutative-ring laws. -/
namespace BOMA.R.DedekindNonzeroInverse001
...
open BOMA.R.DedekindPositiveInverseRelation001
...
/-- Every nonzero selected Dedekind real has a multiplicative inverse witness. -/
...
/-- Commutativity gives the corresponding left inverse witness. -/
...
/-- Multiplicative inverse witnesses are unique once one exists. -/
...
end BOMA.R.DedekindNonzeroInverse001
