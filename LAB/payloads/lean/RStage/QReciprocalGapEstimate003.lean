...
Revision 003 preserves revisions 001/002 as proof-engineering learning artifacts. -/
namespace BOMA.R.QReciprocalGap003
...
theorem q_lt_mul_inverse_of_small_gap
  ...
  have hqr : qLT (qMul q r) a := by
    calc
      qMul q r = qAdd (qMul q a) (qMul q g) := hqexpand
      _ < qAdd (qMul q a) g := hqa_qag
      _ < qAdd (qMul q a) (qMul omq a) := hqag_final
      _ = a := hsumA
