/- Nonzero multiplicative inverse existence revision 004.
Revision 003 is preserved; this revision resolves only the ambiguous rNeg_zero provenance. -/
namespace BOMA.R.DedekindNonzeroInverse004
...
open BOMA.R.DedekindPositiveInverseRelation003
 ...
 theorem rNeg_ne_zero {x : RBOMA}
  ...
  rw [rNeg_involutive,
      BOMA.R.DedekindSignedMulCandidate001.rNeg_zero] at h
  exact h
...
end BOMA.R.DedekindNonzeroInverse004
