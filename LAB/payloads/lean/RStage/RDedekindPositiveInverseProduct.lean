/- Positive inverse-product theorem for the direct Dedekind reciprocal route. -/
namespace BOMA.R.DedekindPositiveInverseProduct001
...
end BOMA.R.DedekindPositiveInverseProduct001
