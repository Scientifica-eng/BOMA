/- Revised positive inverse-product theorem over the V5-passing Q reciprocal-gap 004.
Revisions 001/002 remain preserved as PDSA learning artifacts. -/
namespace BOMA.R.DedekindPositiveInverseProduct003
...
end BOMA.R.DedekindPositiveInverseProduct003
