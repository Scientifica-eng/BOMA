...
-/
namespace BOMA.C.StageTwo.NarrowPairNormInverse001
...
theorem c_conj_involutive
    (C : NarrowROrderedFieldCertificate) (z : CBOMA) :
    cConj (cConj z) = z := by
  apply c_ext
  · rfl
...
theorem c_conj_ofR
    (C : NarrowROrderedFieldCertificate) (a : RBOMA) :
...
theorem c_conj_add
    (C : NarrowROrderedFieldCertificate) (z w : CBOMA) :
  ...
  have hzero : a = rZero := by
    calc
      a = rMulCandidate a rOne :=
        (BOMA.C.StageTwo.NarrowRoutePair001.mul_one_right_from_interface C a).symm
...
theorem c_inverse_from_real_witness
    (C : NarrowROrderedFieldCertificate) (z : CBOMA) (t : RBOMA)
...
theorem cPairFieldCertificate
    (C : NarrowROrderedFieldCertificate) : CPairFieldCertificate where
...
theorem cPairFieldCertificateFromNarrowR : CPairFieldCertificate :=
  cPairFieldCertificate narrowRFromAcceptedProducers

end BOMA.C.StageTwo.NarrowPairNormInverse001
