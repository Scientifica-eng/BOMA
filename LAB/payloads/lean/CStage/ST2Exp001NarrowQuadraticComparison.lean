...
-/
namespace BOMA.C.StageTwo.NarrowQuadraticComparison001
...
structure QuadraticFieldPresentation (R : NarrowROrderedFieldCertificate) where
  carrier : Type
  zero : carrier
  one : carrier
  neg : carrier → carrier
...
def selectedPresentation
    (R : NarrowROrderedFieldCertificate) : QuadraticFieldPresentation R where
  carrier := CBOMA
  zero := cZero
  one := cOne
  neg := cNeg
  ...
  coordinateExpression := by
    intro a b
    exact (BOMA.C.StageTwo.NarrowRoutePair001.coordinate_expression R a b).symm
...
def Related {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
    (x : A.carrier) (y : B.carrier) : Prop :=
  ∃ a b : RBOMA, x = A.coord a b ∧ y = B.coord a b

theorem related_total_left {R : NarrowROrderedFieldCertificate}
...
theorem related_total_right {R : NarrowROrderedFieldCertificate}
...
theorem related_right_unique {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
...
theorem related_left_unique {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
...
theorem related_symm {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
...
theorem related_zero {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) :
    Related A B A.zero B.zero :=
  ⟨rZero, rZero, A.coordinateZero.symm, B.coordinateZero.symm⟩

theorem related_one {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) :
    Related A B A.one B.one :=
  ⟨rOne, rZero, A.coordinateOne.symm, B.coordinateOne.symm⟩

theorem related_real {R : NarrowROrderedFieldCertificate}
...
theorem related_imag {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) :
    Related A B A.imag B.imag :=
  ⟨rZero, rOne, A.coordinateImag.symm, B.coordinateImag.symm⟩

theorem related_neg {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
    {x : A.carrier} {y : B.carrier}
...
theorem related_add {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
...
theorem related_mul {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
    {x z : A.carrier} {y w : B.carrier}
    (hxy : Related A B x y) (hzw : Related A B z w) :
...
theorem related_inverse_witness {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
    {x z : A.carrier} {y w : B.carrier}
    (hxy : Related A B x y) (hzw : Related A B z w)
...
structure QuadraticComparisonCertificate {R : NarrowROrderedFieldCertificate}
...
theorem quadraticComparison
    {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) :
...
structure CoordinateExtractor {R : NarrowROrderedFieldCertificate}
...
def coordinateMap {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
    (E : CoordinateExtractor A) (x : A.carrier) : B.carrier :=
  B.coord (E.re x) (E.im x)

theorem coordinate_map_related {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
    (E : CoordinateExtractor A) (x : A.carrier) :
    Related A B x (coordinateMap A B E x) :=
  ⟨E.re x, E.im x, E.sound x, rfl⟩

theorem coordinate_map_zero {R : NarrowROrderedFieldCertificate}
...
theorem coordinate_map_one {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) (E : CoordinateExtractor A) :
    coordinateMap A B E A.one = B.one :=
  related_right_unique A B
    (coordinate_map_related A B E A.one) (related_one A B)

theorem coordinate_map_real {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) (E : CoordinateExtractor A)
    (a : RBOMA) :
...
theorem coordinate_map_imag {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) (E : CoordinateExtractor A) :
    coordinateMap A B E A.imag = B.imag :=
  related_right_unique A B
    (coordinate_map_related A B E A.imag) (related_imag A B)

theorem coordinate_map_neg {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) (E : CoordinateExtractor A)
    (x : A.carrier) :
...
theorem coordinate_map_add {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) (E : CoordinateExtractor A)
    (x y : A.carrier) :
...
theorem coordinate_map_mul {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) (E : CoordinateExtractor A)
    (x y : A.carrier) :
...
theorem coordinate_maps_inverse_left {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
...
theorem coordinate_maps_inverse_right {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R)
    (EA : CoordinateExtractor A) (EB : CoordinateExtractor B)
    (y : B.carrier) :
...
structure ConstructiveQuadraticIsomorphism {R : NarrowROrderedFieldCertificate}
    (A B : QuadraticFieldPresentation R) where
...
theorem narrowSelectedSelfComparison :
    QuadraticComparisonCertificate
      (selectedPresentation narrowRFromAcceptedProducers)
      (selectedPresentation narrowRFromAcceptedProducers) :=
  quadraticComparison
    (selectedPresentation narrowRFromAcceptedProducers)
    (selectedPresentation narrowRFromAcceptedProducers)

end BOMA.C.StageTwo.NarrowQuadraticComparison001
