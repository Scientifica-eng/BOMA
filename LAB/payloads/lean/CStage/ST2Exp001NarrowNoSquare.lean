...
Purpose:
  ...
  NarrowROrderedFieldCertificate first, then instantiate the result with the
...
-/
namespace BOMA.C.StageTwo.NarrowNoSquare001
...
theorem square_nonnegative_from_accepted_R (x : RBOMA) :
  ...
  square_nonnegative_of_interface narrowRFromAcceptedProducers x
...
theorem minus_one_not_square_from_accepted_R :
  ...
  minus_one_not_square_of_interface narrowRFromAcceptedProducers

end BOMA.C.StageTwo.NarrowNoSquare001
