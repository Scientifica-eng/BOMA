...
STAGE-TWO-LAB      ACTIVE — ST2-EXP-001 selected / one frozen experiment
...
`LAB/PDSA/STAGE_TWO_BRANCH_EXPERIMENT_REGISTER_001.md`; the owner explicitly
selected only `ST2-EXP-001`. Follow the immutable
`LAB/PDSA/PDSA-ST2-EXP-001_NARROW_R_INTERFACE.md` Plan, preserve the accepted
N→C baseline and every alternative, and never merge into `main` without the
owner's separate explicit instruction.
